 ...
 */
public class TestCaseWithParam{
    ...
    private TestCaseParams testCaseParams;
    ...
    public TestCaseParams getTestCaseParams() {
        return testCaseParams;
    }

    public void setTestCaseParams(TestCaseParams testCaseParams) {
